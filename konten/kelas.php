                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped table-sm">
                            ...
                            $sql = "select kelas.* from kelas where kelas.dihapus_pada IS NULL and kelas.id_tahun_ajar='$id_tahun_ajar' and kelas.id_prodi='$id_prodi'";
                            //echo $sql;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-link" data-toggle="modal" data-target="#editModal<?= $kolom['id_kelas']; ?>"><i class="fas fa-edit"></i></button>
                                        <button type="button" class="btn btn-link"><a onclick="return confirm('Apakah Yakin Data Ini Dihapus??')" href="aksi/kelas.php?aksi=hapus&id=<?= $kolom['id_kelas']; ?>"><i class="fas fa-trash"></i></a></button>
                                        <button type="button" class="btn btn-link"><a href="index.php?p=kelas-anggota&id=<?= $kolom['id_kelas']; ?>"><i class="fas fa-user"></i></a></button>
                                    </td>
                                </tr>
                                <!-- Modal Edit -->
                                <div class="modal fade" id="editModal<?= $kolom['id_kelas']; ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="aksi/kelas.php" method='post'>
                                                    <input type="hidden" name="aksi" value="ubah">
                                                    <input type="hidden" name="id_kelas" value="<?= $kolom['id_kelas']; ?>">
